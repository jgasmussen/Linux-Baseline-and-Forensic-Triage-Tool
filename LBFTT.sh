...
echo "COLLECTING MEMORY IMAGE WITH MICROSOFT'S AVML..." | tee -a $DEST/$baseline_collection_log
echo " " >> $DEST/$baseline_collection_log
./avml $DEST/$memory_image | tee -a $DEST/$baseline_collection_log
echo " " >> $DEST/$baseline_collection_log
echo "DONE!" | tee -a $DEST/$baseline_collection_log
echo " " >> $DEST/$baseline_collection_log
echo "======================================================================================" >> $DEST/$baseline_collection_log
sleep 2
echo "Computing HASH value of the collected AVML Memory File: $memory_image ..." | tee -a $DEST/$baseline_collection_log
sleep 8
echo " " >> $DEST/$baseline_collection_log
echo "md5sum=$(md5sum /mnt/FORENSICS/*.mem)" | tee -a $DEST/$baseline_collection_log
echo "sha1sum=$(sha1sum /mnt/FORENSICS/*.mem)" | tee -a $DEST/$baseline_collection_log
echo "sha256sum=$(sha256sum /mnt/FORENSICS/*.mem)" | tee -a $DEST/$baseline_collection_log
echo " " >> $DEST/$baseline_collection_log
echo "COLLECTING MEMORY IMAGE...DONE!" | tee -a $DEST/$baseline_collection_log
sleep 5
echo "**************************************************************************************" >> $DEST/$baseline_collection_log
echo "======================================================================================" >> $DEST/$baseline_collection_log
echo " " >> $DEST/$baseline_collection_log
...
FILE_TIMESTAMPS="$FAST_collection.FILE_TIMESTAMPS"
memory_image="$hostname.$day.mem"
...
echo "======================================================================================" >> $DEST/$FAST_log
sleep 2
echo "Computing HASH value of the collected AVML Memory File: $memory_image ..." | tee -a $DEST/$FAST_log
sleep 8
echo " " >> $DEST/$FAST_log
echo "md5sum=$(md5sum /mnt/FORENSICS/*.mem)" | tee -a $DEST/$FAST_log
echo "sha1sum=$(sha1sum /mnt/FORENSICS/*.mem)" | tee -a $DEST/$FAST_log
echo "sha256sum=$(sha256sum /mnt/FORENSICS/*.mem)" | tee -a $DEST/$FAST_log
echo " " >> $DEST/$FAST_log
...
date +"%m/%d/%Y %T" >> $DEST/$hostname-Directory_Listing.txt
echo "See $hostname-Directory_Listing.txt for a complete directory listing." >> /mnt/FORENSICS/$FAST_log
echo " " >> $DEST/$FAST_log
echo "======================================================================================" >> $DEST/$FAST_log
...
echo "======================================================================================" >> $DEST/$FAST_log
echo "First, grabbing full file timestamps for all files..." | tee -a $DEST/$FAST_log
echo "find $FILES -type f -exec stat {} \; | tee -a /$DEST/$FAST_log" | tee -a $DEST/$FAST_log
...
echo " " >> $DEST/$FAST_log
echo "======================================================================================" >> $DEST/$FAST_log
echo "Computing HASH value of the Triage Collection File: $FAST_collection.tar ..." | tee -a $DEST/$FAST_log
echo " " >> $DEST/$FAST_log
echo "md5sum=$(md5sum /mnt/FORENSICS/*.tar)" | tee -a $DEST/$FAST_log
echo "sha1sum=$(sha1sum /mnt/FORENSICS/*.tar)" | tee -a $DEST/$FAST_log
echo "sha256sum=$(sha256sum /mnt/FORENSICS/*.tar)" | tee -a $DEST/$FAST_log
echo " " >> $DEST/$FAST_log
echo "======================================================================================" >> $DEST/$FAST_log
...
FILE_TIMESTAMPS="$FULL_collection.FILE_TIMESTAMPS"
memory_image="$hostname.$day.mem"
...
echo "======================================================================================" >> $DEST/$FULL_log
sleep 2
echo "Computing HASH value of the collected AVML Memory File: $memory_image ..." | tee -a $DEST/$FULL_log
sleep 8
echo " " >> $DEST/$FULL_log
echo "md5sum=$(md5sum $DEST/$memory_image)" | tee -a $DEST/$FULL_log
echo "sha1sum=$(sha1sum $DEST/$memory_image)" | tee -a $DEST/$FULL_log
echo "sha256sum=$(sha256sum $DEST/$memory_image)" | tee -a $DEST/$FULL_log
echo " " >> $DEST/$FULL_log
...
echo " " >> $DEST/$FULL_log
echo "======================================================================================" >> $DEST/$FULL_log
echo "Computing HASH vaule of the Triage Collection File: $FULL_collection.tar ..." | tee -a $DEST/$FULL_log
echo " " >> $DEST/$FULL_log
echo "md5sum=$(md5sum /mnt/FORENSICS/*.tar)" | tee -a $DEST/$FULL_log
echo "sha1sum=$(sha1sum /mnt/FORENSICS/*.tar)" | tee -a $DEST/$FULL_log
echo "sha256sum=$(sha256sum /mnt/FORENSICS/*.tar)" | tee -a $DEST/$FULL_log
echo " " >> $DEST/$FULL_log
echo "======================================================================================" >> $DEST/$FULL_log
